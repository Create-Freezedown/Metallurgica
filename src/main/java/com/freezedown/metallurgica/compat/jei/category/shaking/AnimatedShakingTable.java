...
public class AnimatedShakingTable extends AnimatedKinetics {
    ...
    public void draw(PoseStack matrixStack, int xOffset, int yOffset) {
        ...
        this.blockElement(MetallurgicaBlocks.shakingTable.getDefaultState().setValue(ShakingTableBlock.HORIZONTAL_FACING, Direction.WEST)).rotateBlock(0.0, 0.0, 0.0).scale(scale).render(matrixStack);
