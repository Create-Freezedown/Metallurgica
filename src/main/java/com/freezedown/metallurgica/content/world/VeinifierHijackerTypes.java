...
public enum VeinifierHijackerTypes {
    ...
    BAUXITE(MetallurgicaMaterials.BAUXITE.MATERIAL.stone().get().defaultBlockState(), MetallurgicaMaterials.BAUXITE.MATERIAL.depositBlock().get().defaultBlockState(), TFMGPaletteStoneTypes.BAUXITE.baseBlock.get().defaultBlockState(), -30, 70),
