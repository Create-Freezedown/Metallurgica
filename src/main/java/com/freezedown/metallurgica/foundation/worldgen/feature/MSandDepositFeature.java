...
import com.freezedown.metallurgica.foundation.worldgen.MBaseConfigDrivenSandFeature;
...
public class MSandDepositFeature extends MBaseConfigDrivenSandFeature<MConfigDrivenSandFeatureConfiguration> {

    public MSandDepositFeature() {
        super(MConfigDrivenSandFeatureConfiguration.CODEC);
    }


    @Override
    public boolean place(FeaturePlaceContext<MConfigDrivenSandFeatureConfiguration> pContext) {
        RandomSource random = pContext.random();
        BlockPos blockpos = pContext.origin();
        WorldGenLevel worldgenlevel = pContext.level();
        MConfigDrivenSandFeatureConfiguration oreconfiguration = pContext.config();
    ...
    protected boolean doPlace(WorldGenLevel pLevel, RandomSource pRandom, MConfigDrivenSandFeatureConfiguration pConfig, double pMinX,
