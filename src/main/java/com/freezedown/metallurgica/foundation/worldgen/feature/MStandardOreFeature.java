...
public class MStandardOreFeature extends MBaseConfigDrivenOreFeature<MConfigDrivenOreFeatureConfiguration> {
    
    public MStandardOreFeature() {
    ...
    protected boolean doPlace(WorldGenLevel pLevel, RandomSource pRandom, MConfigDrivenOreFeatureConfiguration pConfig, double pMinX,
