...
import dev.metallurgists.metallurgica.compat.jei.category.drill.DrillingRecipe;
import dev.metallurgists.metallurgica.content.machines.vat.floatation_cell.FlotationCatalyst;
import dev.metallurgists.metallurgica.content.metalworking.advanced_casting.AdvancedCastingRecipe;
import dev.metallurgists.metallurgica.content.machines.reverbaratory.ReverbaratoryCookingRecipe;
import dev.metallurgists.metallurgica.content.machines.kiln.BakingRecipe;
import dev.metallurgists.metallurgica.content.machines.shaking_table.ShakingRecipe;
import dev.metallurgists.metallurgica.content.machines.sluice_belt.SluicingRecipe;
import dev.metallurgists.metallurgica.content.primitive.ceramic.ceramic_mixing_pot.CeramicMixingRecipe;
import dev.metallurgists.metallurgica.content.primitive.pit_smelting.PitFuelRecipe;
...
public enum MetallurgicaRecipeTypes implements IRecipeTypeInfo {
    ...
    flotation_catalyst(FlotationCatalyst::new)
    ;
